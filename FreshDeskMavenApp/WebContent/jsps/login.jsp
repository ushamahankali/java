<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="com.ektha.freshdeskmavenapp.entity.User" %>
    <!DOCTYPE html>
<html>
<head>
...
<p align ="right">
<a href = ${pageContext.request.contextPath}/index.html>
<input type="button" value="SignOut" align="right">
</a>
</p>
</h2>
</div>
...
<p>Welcome to the freshdesk login page</p>
   ...
   <br>   <br>
<div class="navbar">
  <a href=/freshdesk/home.html>Home</a> 
