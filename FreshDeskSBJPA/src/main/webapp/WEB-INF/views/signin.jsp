...
<!-- 	 <li class="nav-item dropdown active">
  		<a class="nav-link dropdown-toggle active" href="ticket" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Ticket<span class="sr-only">(current)</span></a>
...
<form:form id="signinForm" modelAttribute="signin" action="signinProcess" method="post" onsubmit="return validateForm()">
  <table align="center">
      ...
      <tr>
          ...
          <td>
              ...
              <input type="text" class="form-control" id="username" name="username" placeholder="username" onsubmit="return validate()">
      ...
      <tr>
          ...
          <td>
              ...
              <input type="text" class="form-control" id="password" name="password" placeholder="password" onsubmit="return validate()">
        		<!-- Name must be between 2 and 10 characters -->
          </td>
      </tr>
      ...
      <tr>
          <td></td>
          <td><a class="link" href="signup">Don't have account?</a>
          </td>
      </tr>
  </table>
</form:form>
...
<section class=top>
    ...
    <h1 align="center">FreshDesk Next Generation Find us on</h1>
