...
<div class="lin" align="center">
<a class="link" href="createticket"><input type="submit" value="Create Ticket" class="btn btn-primary"></a>
<a class="link" href="viewticket"><input type="submit" value="View Ticket" class="btn btn-primary"></a> 
</div>
