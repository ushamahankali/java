<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"  import="com.ektha.freshdesk.entity.Ticket, java.util.List,java.util.ArrayList" %>
<!DOCTYPE html>
<html>
...
<div class="navbar">
  ...
  <a href=jsps/ticket.jsp>Ticket</a> 
 <a href=jsps/signup.jsp>SignUp</a> 
  <a href=jsps/login.jsp>Login</a>
</div>
<br><br>
