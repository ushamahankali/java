...
// Use to get a proxy class for IP2GeoSoap
	...
	/**
	 * Our system uses a multiple sources for resolution. Including a host database,
	 * trace route information, and other systems. Resolves IP addresses to
	 * Organization, Country, City, and State/Province, Latitude, Longitude. In most
	 * US cities it will also provide some extra information such as Area Code, and
	 * more.
	 */
	...
	public IP2GeoLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName)
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (com.cdyne.ws.IP2GeoSoap.class.isAssignableFrom(serviceEndpointInterface)) {
				com.cdyne.ws.IP2GeoSoapStub _stub = new com.cdyne.ws.IP2GeoSoapStub(
						new java.net.URL(IP2GeoSoap_address), this);
				_stub.setPortName(getIP2GeoSoapWSDDServiceName());
				return _stub;
			}
