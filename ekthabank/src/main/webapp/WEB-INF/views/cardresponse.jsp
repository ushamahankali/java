...
<body style="background-color: #f2f2f2;">
	...
	<div>
		...
		<nav class="navbar navbar-expand-sm  justify-content-center">
			<ul class="navbar-nav">
				<li class="nav-item"><a class="nav-link" href="creditcard">Back</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="cardactivate">Activate
						a Card</a></li>
				<li class="nav-item"><a class="nav-link" href="cardregister">Register
						Now</a></li>
			</ul>
		</nav>
	</div>
