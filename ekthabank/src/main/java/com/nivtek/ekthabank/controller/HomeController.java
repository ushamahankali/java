...
public class HomeController {
	...
	@RequestMapping(value = "/cardactivate", method = RequestMethod.GET)
	public String showCardActivate() {
	...
	@RequestMapping(value = "/cardregister", method = RequestMethod.GET)
	public String showCardRegistration() {

		/*
		 * if (logger.isDebugEnabled()) { logger.debug("getWelcome is executed!"); }
		 */

		logger.warn("inside cardregister");
